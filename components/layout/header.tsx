                  ...
                  <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                      <li className="row-span-3">
                        <Link href="/cities" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                          <div className="text-sm font-medium leading-none">Popular Cities</div>
                      ...
                      <li>
                        <Link href="/developments" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                      ...
                      <li>
                        <Link href="/market-trends" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
              ...
              {user ? (
                ...
                <div className="flex items-center space-x-2">
                  <Link href="/auth/login">
                    <Button variant={isTransparent ? "outline" : "ghost"} className={isTransparent ? "border-white hover:bg-white/20" : ""}>
                      Login
                    </Button>
                  </Link>
                  <Link href="/auth/register">
                    <Button className={isTransparent ? "bg-white text-emerald-800 hover:bg-white/90" : "bg-emerald-600 hover:bg-emerald-700 text-white"}>
                      Register
                    </Button>
                  </Link>
                </div>
